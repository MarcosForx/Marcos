//
//  Album3TableViewController.swift
//  SegundoParcial
//
...
class Album3TableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "album3", for: indexPath)

        cell.textLabel?.text = album3[indexPath.row].titulo
        
        cell.detailTextLabel?.text = album3[indexPath.row].precio
